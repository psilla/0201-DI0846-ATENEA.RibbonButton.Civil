...
namespace TYPSA.PS.RibbonButton.Civil
{
    internal class cls_00_ExportAteneaCheckToHtml
    {
        ...
        )
        {
            ...
            sb.AppendLine("Generated by TYPSA Atenea Model Checker<br>");
            ...
            string htmlPath = Path.Combine(
                selectedFolderPath, $"AteneaModelChecker_Report_{safeProjectCode}_{DateTime.Now:yyyyMMdd_HHmmss}.html"
            );
