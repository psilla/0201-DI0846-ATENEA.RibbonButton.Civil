...
namespace TYPSA.PS.RibbonButton.Civil.Source.Class.Main
{
    internal class cls_00_FilterJsonBySelectedPsets
    {
        ...
        {
            return isSpanish
                ? "Selecciona los Property Sets del archivo de configuración que deseas crear o actualizar en el modelo.\n\n" +
                  "Los Property Sets que ya estén configurados en el conjunto web no aparecerán en este listado."
                : "Select the Property Sets from the configuration file that you want to create or update in the model.\n\n" +
                  "Property Sets that are already configured in the web configuration set will not appear in this list.";
        }
        ...
        )
        {
            ...
            // Validamos
            if (allPsetNamesFromJson.Count == 0)
            {
                return dataJsonByModel;
            }
            ...
            else
            {
                ...
                // -----------------------------
                // Filtramos posibles Psets a incorporar al Set
                // -----------------------------
            ...
            List<string> selectedPsets = cls_00_InstaForm_CheckedListBox.CheckListBoxFormSearchOut(
                formTitle, selectablePsetNames, selectablePsetNames
            );
